...
<br>
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="/datakategori/update" method="post">
               {{ csrf_field() }}
              <div class="box-body">
                  <input type="hidden" name="id_jadwal" value="{{ $li->id_jadwal }}"> <br/>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">ID Jadwal</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="id_jadwal" value="{{ $li->id_jadwal }}" placeholder="ID Jadwal">
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Hari</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="hari" value="{{ $li->hari }}" placeholder="hari">
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Tanggal</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="tanggal" value="{{ $li->tanggal }}" placeholder="Tanggal">
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Jam</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="jam" value="{{ $li->jam }}" placeholder="Jam">
                  </div>
